...
Designed with two main goals in mind:

1. **Implement just enough features from the C language to be able to self compile**

2. **Simplicity and readability comes first, speed and efficiency comes last**


Examples showing how the "Hello world" program is compiled to different targets:
...
and just for comparison, this is how Visual C++ compiles "Hello world":
